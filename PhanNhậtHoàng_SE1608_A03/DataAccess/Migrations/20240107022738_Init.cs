...
namespace DataAccess.Migrations
{
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "CustomerId", "Birthday", "City", "Country", "CustomerName", "Email", "Password" },
                values: new object[,]
                {
                    { 1, new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "City 1", "Country 1", "Customer 1", "customer1@example.com", "password1" },
                    { 2, new DateTime(1990, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "City 2", "Country 2", "Customer 2", "customer2@example.com", "password2" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 1, 7, 9, 27, 38, 117, DateTimeKind.Local).AddTicks(6508), "Completed", new DateTime(2024, 1, 8, 9, 27, 38, 117, DateTimeKind.Local).AddTicks(8561), 100.00m },
                    { 2, 2, new DateTime(2024, 1, 7, 9, 27, 38, 117, DateTimeKind.Local).AddTicks(9402), "Completed", new DateTime(2024, 1, 9, 9, 27, 38, 117, DateTimeKind.Local).AddTicks(9406), 150.00m }
                });
